...
#              WRITE_YOUR_ANSWER_HERE, The upper left-hand corner.
#
...
#              WRITE_YOUR_ANSWER_HERE,Downwards.
#
...
#                WRITE_YOUR_ANSWER_HERE,Ellipse and Rectangle
#
#          -- Write the names of three METHODs that Circle objects have:
#                WRITE_YOUR_ANSWER_HERE, attach_to, clone, and move_by
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#                WRITE_YOUR_ANSWER_HERE, center, radius,
#
...
circ = rg.Circle(rg.Point(100,100),10)
circ.
